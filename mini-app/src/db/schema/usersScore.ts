import { pgTable, serial, bigint, smallint, varchar, boolean, index, uniqueIndex, pgEnum } from "drizzle-orm/pg-core";
...
export const usersScore = pgTable(
  "users_score",
  {
    // Using serial for id (adjust if you need a bigint auto-increment)
    id: serial("id").primaryKey(),
    userId: bigint("user_id", { mode: "number" }).notNull(),
    // If you have a users table defined, you can add a foreign key reference like:

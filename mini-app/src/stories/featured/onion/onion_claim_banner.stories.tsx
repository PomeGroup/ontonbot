...
import SnapshotClaimPointsBanner from "@/app/(landing-pages)/onion-snapshot/_components/SnapshotClaimpointsBanner";
...
const meta: Meta<AirdropBannerStoryArgs> = {
  title: "Featured/Onion/OnionClaimBanner",
  component: () => (
    <div className="min-w-[400px] flex">
      <SnapshotClaimPointsBanner />
    </div>
  ),
  decorators: [
    (Story, context) => {
...
export const Primary: Story = {
  args: {
    className: "w-full",
    mockConfig: {
      snapshot_claim_end_date: new Date(Date.now() + 1000 * 60 * 60 * 24 * 10),
      snapshot_claim_disabled: false,
    },
  },
};

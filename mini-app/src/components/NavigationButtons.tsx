 ...
 */
export interface NavAction extends Omit<React.ComponentPropsWithoutRef<typeof Button>, "children"> {
 ...
 */
export interface NavigationButtonsProps extends Omit<React.ComponentPropsWithoutRef<typeof Block>, "children"> {
...
export default function NavigationButtons({
  ...
  const containerClasses = clsx(
    ...
    layout === "horizontal" ? "flex flex-row justify-end space-x-3" : "flex flex-col space-y-3",

  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-cn-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        ontonDark:
          "flex items-center shrink-0 font-light text-xs rounded-md border-none relative overflow-hidden  items-center  text-center  bg-light-grey  whitespace-nowrap   p-1 py-0.5 text-xs leading-3.5",

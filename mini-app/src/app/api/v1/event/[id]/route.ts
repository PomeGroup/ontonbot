...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  //   const isSoldOut = (soldTicketsCount[0].count as unknown as number) >= (event.capacity);
  ...
  //   const { valid_nfts_no_info, valid_nfts_with_info } = await getValidNfts(ownerAddress, ticket?.collectionAddress!, userId);

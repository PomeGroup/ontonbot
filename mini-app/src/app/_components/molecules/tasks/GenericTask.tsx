...
const GenericTask: React.FC<{
    ...
    return (
        <div
            className={cn("my-4 rounded-[14px] p-4 border border-separator flex items-center justify-start cursor-pointer", className)}
            onClick={onClick}
        >
            <div
                className={twMerge(
            ...
            <div className="flex flex-col">
                <div className="text-[17px] font-medium leading-[22px]">{title}</div>

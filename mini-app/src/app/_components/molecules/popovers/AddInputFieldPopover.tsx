                    ...
                    <div className="grid gap-2">
                        <div className="grid grid-cols-3 items-center gap-4">
                            <Label htmlFor="title">Title
                                {
                                    zodErrors?.title && <div className="text-red-500 col-start-3 text-[12px]">{zodErrors.title}</div>
                                }
                            </Label>
                            <Input
                                id="title"
                        ...
                        <div className="grid grid-cols-3 items-center gap-4">
                            <Label htmlFor="description">Description
                                ...
                                {
                                    zodErrors?.description && <div className="text-red-500 col-start-3 text-[12px]">{zodErrors.description}</div>
                                }
                            </Label>
                            <Input
                                id="description"
                        ...
                        <div className="grid grid-cols-3 items-center gap-4">
                            <Label htmlFor="placeholder">Placeholder
                                ...
                                {
                                    zodErrors?.placeholder && <div className="text-red-500 col-start-3 text-[12px]">{zodErrors.placeholder}</div>
                                }
                            </Label>
                            <Input
                                id="placeholder"
                                ...
                                onChange={(e) =>
                                    handleInputChange(e, 'placeholder')
                                }
                        ...
                        <div className="grid grid-cols-3 items-center gap-4">
                            <Label htmlFor="emoji">Emoji
                                ...
                                {
                                    zodErrors?.emoji && <div className="text-red-500 col-start-3 text-[12px]">{zodErrors.emoji}</div>
                                }
                            </Label>
                            <Input
                                id="emoji"

...
const MainFilterDrawer: React.FC<MainFilterDrawerProps> = ({
  ...
  return (
    <Drawer onOpenChange={onOpenChange}>
      <DrawerTrigger>
        <button className="ml-4 p-2 rounded-md text-blue-600 hover:text-blue-700">
          ...
          <div className="space-y-4">
            ...
            >
              <label className="flex justify-between items-center  border-b-[1px] border-b-zinc-700 pb-2">
                ...
                <Radio name="radio" value="start_date_desc" />
              </label>
              ...
              <label className="flex justify-between items-center">
                ...
                <Radio name="radio" value="most_people_reached" />
              </label>
            </RadioGroup>
          </div>
        </div>

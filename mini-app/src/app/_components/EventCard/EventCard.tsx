                ...
                <div className="flex pt-1 pr-0 pb-3 pl-0 flex-col gap-1 items-start self-stretch grow flex-nowrap relative">
                    <div className="flex items-center self-stretch flex-nowrap relative">
                        ...
                        </span>
                        {
                            ticket_price > 0 && (
                                <button
                                    className="flex w-9 pt-0.5 pr-1 pb-0 pl-1 items-center shrink-0 flex-nowrap bg-gray-200 dark:bg-gray-800 rounded-md border-none relative overflow-hidden">
                                    <span
                                        className="h-3.5 shrink-0 basis-auto font-sans text-xs font-medium leading-3.5 text-black dark:text-white relative text-left whitespace-nowrap">
                                        ${ticket_price}
                                    </span>
                                </button>
                            )
                    ...
                    <div className="flex gap-1.5 items-center self-stretch flex-nowrap relative">
                        <span
                            className="h-5.5 grow basis-auto font-sans text-lg font-semibold leading-5.5 text-black dark:text-white relative text-left line-clamp-2">
                            {title}
                        </span>
                    </div>
                    {organizerLink ? (

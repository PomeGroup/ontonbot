...
const BEARER =
  "Bearer b413D1dd233224t3SD21Pf6UFEJ34jwowevlowqekKPVPKVWE133242552P948okmreboerbeobrmbermbw";
const AUTH_HEADER = { Authorization: BEARER };

export async function fetchWebsiteData(hash: string) {
  if (
    hash === "b09b30dbef8f52b796ded292c240b661bdf68d7cff9337db7a15230af0fa48d3"
  ) {
    return {
      name: "Global Chat",

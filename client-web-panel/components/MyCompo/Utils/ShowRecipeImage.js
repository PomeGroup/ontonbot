...
const ShowRecipeImage = ({ recipe, width = 40, height = 40, className = "borRadius100", enableDialog = false }) => {
    ...
    return (
        <>
            {recipe?.elementsPoster ? (
                <>
                    <Image
                        src={srcImg(recipe.elementsPoster)}
...
export default ShowRecipeImage;

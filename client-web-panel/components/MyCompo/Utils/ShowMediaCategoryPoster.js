...
const ShowMediaCategoryPoster = ({ media_category, width = 40, height = 40, className = "borRadius100", enableDialog = false }) => {
    ...
    return (
        <>
            {media_category?.poster ? (
                <>
                    <Image
                        src={srcImg(media_category.poster)}
                        alt={media_category?.title || 'User'}
                        width={width}
                        height={height}
                        className={className}
...
export default ShowMediaCategoryPoster;
